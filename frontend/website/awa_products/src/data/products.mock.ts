...
export const products: Product[] = [
  ...
  {
    id: "prod-003",
    name: "FreshGuard Premium Laundry Detergent (10 kg)",
    ...
    inStock: true,
    usageInstructions: [
      "Use 1 scoop (60 g) for a regular load, 2 scoops for heavily soiled laundry.",
  ...
  {
    id: "prod-004",
    name: "SoftTouch Fabric Conditioner (3 L)",
    category: "Laundry Care",
    subCategory: "Laundry Care",
    image:
    ...
    usageInstructions: [
      ...
      "Add 45 ml to the fabric softener compartment of your washing machine.",
  ...
  // ─── Cleaning Chemicals (5 products) ─────────────────
  {
    id: "prod-001",
    name: "CrystalClear Glass & Mirror Cleaner (750 ml)",
  ...
  {
    id: "prod-006",
    name: "KitchenKleen Industrial Oven Degreaser (5 L)",
    category: "Cleaning Chemicals",
    subCategory: "Cleaning Chemicals",
    image:
  ...
  {
    id: "prod-008",
    name: "GreaseZero Commercial Dishwash Gel (5 L)",
    category: "Cleaning Chemicals",
    subCategory: "Cleaning Chemicals",
    image:
    ...
    inStock: true,
    usageInstructions: [
      "Add 5–10 ml per sink fill or dishwasher compartment.",
  ...
  {
    id: "prod-009",
    name: "HandGuard Heavy-Duty Hand Cleaner (5 L)",
    category: "Cleaning Chemicals",
    subCategory: "Cleaning Chemicals",
    image:
    ...
    inStock: true,
    usageInstructions: [
      "Dispense 3–5 ml onto dry or wet hands.",
  ...
  {
    id: "prod-011",
    name: "GermShield Hospital-Grade Disinfectant (5 L)",
    category: "Cleaning Chemicals",
    subCategory: "Cleaning Chemicals",
    image:
  ...
  // ─── Janitorial Cleaning Supplies (3 products) ────────
  {
    id: "prod-002",
    name: "PowerWash Multi-Surface Floor Cleaner (5 L)",
    category: "Janitorial Cleaning Supplies",
    subCategory: "Janitorial Cleaning Supplies",
    image:
    ...
    inStock: true,
    usageInstructions: [
      "Add 2 capfuls (30 ml) to a bucket of warm water.",
  ...
  {
    id: "prod-005",
    name: "DeskShine Surface Disinfecting Wipes (Canister of 80)",
    category: "Janitorial Cleaning Supplies",
    subCategory: "Janitorial Cleaning Supplies",
    image:
      "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=800",
    description:
      "Pre-moistened disinfecting wipes designed for desks, keyboards, phones, and shared surfaces. Kills 99.9% of germs. Anti-static formula repels dust. Fresh citrus scent.",
    inStock: true,
    usageInstructions: [
  ...
  {
    id: "prod-007",
    name: "TuffScrub Concrete & Warehouse Floor Cleaner (20 L)",
    category: "Janitorial Cleaning Supplies",
    subCategory: "Janitorial Cleaning Supplies",
    image:
  ...
  // ─── Disposable Food Service (0 products) ─────────────
  // ─── Paper Products (0 products) ──────────────────────
  // ─── Trash Liners (1 product) ─────────────────────────
  {
    id: "prod-010",
    name: "CleanShip Surface Sanitiser Spray (2 L)",
    category: "Trash Liners",
    subCategory: "Trash Liners",
    image:
      "https://images.unsplash.com/photo-1602928321679-560bb453f190?w=600&h=400&fit=crop",
    description:
      "Fast-acting sanitiser spray for bin liners, waste areas, pallets, and dispatch surfaces. Kills 99.9% of bacteria and viruses on contact. Non-staining, quick-dry formula. Ideal for warehouses, fulfilment centres, and logistics hubs.",
    inStock: false,
    usageInstructions: [
